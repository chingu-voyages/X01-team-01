    ...
    <div className="container">
      ...
      <main className="mt-6">
        <div className="flex justify-between">
          <div className="text-2xl tracking-tighter">Prompt History</div>
          <div className="flex gap-4 transition-colors duration-200">
            <div
              className={`text-xl pr-4 border-r border-black/20 hover:cursor-pointer
          ...
          <div className="flex gap-4">
            ...
            <ListFilter className="hover:cursor-pointer" />
          </div>
