      ...
      <Dialog open={isModalOpen} onOpenChange={onClose}>
        <DialogContent className="max-w-[90vw] md:max-w-3xl p-6">
          ...
          <div className="flex flex-col md:flex-row gap-2 justify-around">
            <button className="w-full md:w-auto px-4 py-2 border rounded-md">Keep original</button>
            <button className="w-full md:w-auto px-4 py-2 bg-blue-500 text-white rounded-md">Apply suggestion</button>
          </div>
        </DialogContent>
      </Dialog>
    </div>
